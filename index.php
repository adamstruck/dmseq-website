	...
	<body>
		...
		<!-- Main -->
			<div id="main">
				...
				<!-- Intro -->
					<section id="top" class="one dark cover">
						<div class="container">
							...
							<header>
								<h2 class="alt"><strong>The Myotonic Dystrophy Deep Sequencing Data Repository</strong></h2>
								<p>A collaboration to comprehensively survey the myotonic dystrophy transcriptome</p>
							</header>
                ...
                <!-- Genome Browser -->
					<section id="browser" class="three">
						<div class="container">
							<header>
